...
<p align="center">
  <img src="Documents/Images/customprompt.png" alt="Custom prompt" width="700", height="298"/>
</p>

3. Under **Instructions**, use '/' to add an input, and select Text. Name the input "Training Category":

<p align="center">
  <img src="Documents/Images/trainingcategory.png" alt="Custom prompt" width="470", height="382"/>
</p>
    

4. Paste the following prompt instructions under **Instructions**:
...
_Use input variable: **trainingCategory**_
 ...
 5. Now save the prompt and close. Go to the inputs of the prompt and select the **Training Category** variable to assign the output from the previous step to the new variable: 

<p align="center">
  <img src="Documents/Images/trainingcategoryvariable.png" alt="prompt" width="700", height="402"/>
</p>
...
9. Select the arrow on outputs and create a new variable. Rename the **Output** variable to:  **promptOutput**
 ...
 <p align="center">
  <img src="Documents/Images/promptoutputs.png" alt="prompt" width="700", height="400"/>
</p>
