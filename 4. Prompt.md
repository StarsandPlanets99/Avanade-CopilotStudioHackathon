...
_Use input variable: **trainingCategory**_
 ...
 5. Now add the input variable trainingCategory. You need the course chosen in the agent chat to be used in the prompt output to provide the cost of the course
